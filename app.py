...
# ---------------------------------------------------------------------------
# Staff Portal analytics — read-only, built entirely from data already in
# reports_df (no new dependencies, no external services, no changes to how
# reports are saved). Rendered inside the Staff Portal section below,
# right after the status count metrics.
# ---------------------------------------------------------------------------
